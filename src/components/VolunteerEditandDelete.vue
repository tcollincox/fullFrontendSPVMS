...
<template>
  <div id="page">
    ...
    <b-button @click="submit(), $emit('change-to-display')">Submit</b-button>
    <b-button @click="clearForm(), $emit('change-to-display')">Cancel</b-button>
...
export default {
  ...
  data(){
    return{
      ...
      newVolunteer:{
        ...
        approvalStatus: this.volunteer.approvalStatus,
        preferredCenters: this.volunteer.preferredCenters,
        skills: this.volunteer.skills,
        avalibilityTimes: this.volunteer.avalibilityTimes,
        address: this.volunteer.address,
        homePhone: this.volunteer.homePhone,
        cellPhone:this.volunteer.cellPhone,
        workPhone:this.volunteer.workPhone,
        email:this.volunteer.email,
        educationalBackground:this.volunteer.educationalBackground,
        licenses:this.volunteer.licenses,
        emergencyContactName:this.volunteer.emergencyContactName,
        emergencyContactPhone:this.volunteer.emergencyContactPhone,
        emergencyContactEmail:this.volunteer.emergencyContactEmail,
        emergencyContactAddress:this.volunteer.emergencyContactAddress,
        driverLicenseOnFile:this.volunteer.driverLicenseOnFile,
        socialSecurityOnFile:this.volunteer.socialSecurityOnFile,
      },
      volunteerValidation:{
        firstName: false,
        lastName: false,
  ...
  methods:{
    ...
    submit(){
      if(this.validate()){
        let path = `http://localhost:3001/volunteers/Update/${this.volunteer._id}`
        console.log(path);
        this.axios.put(path, {
    ...
    clearForm(){
        this.newVolunteer.firstName= this.volunteer.firstName;
        this.newVolunteer.lastName= this.volunteer.lastName;
        this.newVolunteer.username= this.volunteer.username;
        this.newVolunteer.password= this.volunteer.password;
        this.newVolunteer.approvalStatus= this.volunteer.approvalStatus;
        this.newVolunteer.preferredCenters= this.volunteer.preferredCenters;
        this.newVolunteer.skills= this.volunteer.skills;
        this.newVolunteer.avalibilityTimes= this.volunteer.avalibilityTimes;
        this.newVolunteer.address= this.volunteer.address;
        this.newVolunteer.homePhone= this.volunteer.homePhone;
        this.newVolunteer.cellPhone=this.volunteer.cellPhone;
        this.newVolunteer.workPhone=this.volunteer.workPhone;
        this.newVolunteer.email=this.volunteer.email;
        this.newVolunteer.educationalBackground=this.volunteer.educationalBackground;
        this.newVolunteer.licenses=this.volunteer.licenses;
        this.newVolunteer.emergencyContactName=this.volunteer.emergencyContactName;
        this.newVolunteer.emergencyContactPhone=this.volunteer.emergencyContactPhone;
        this.newVolunteer.emergencyContactEmail=this.volunteer.emergencyContactEmail;
        this.newVolunteer.emergencyContactAddress=this.volunteer.emergencyContactAddress;
        this.newVolunteer.driverLicenseOnFile=this.volunteer.driverLicenseOnFile;
        this.newVolunteer.socialSecurityOnFile=this.volunteer.socialSecurityOnFile;
      }
  },
  mounted(){
    this.axios
